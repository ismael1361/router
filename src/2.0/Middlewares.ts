...
import { FileInfo, FilesRequest, RequestHandler, Request, Response } from "./type";
 ...
 * @returns {RequestHandler<Request, Response>} Uma função de middleware do Express.
 *
 * @example
 ...
 * });
 */
export const json = (options?: OptionsJson | undefined): RequestHandler<Request, Response> => {
 ...
 * });
 */
export const raw = (options?: Options): RequestHandler<Request, Response> => {
 ...
 * });
 */
export const text = (options?: OptionsText): RequestHandler<Request, Response> => {
 ...
 * });
 */
export const urlencoded = (options?: OptionsUrlencoded): RequestHandler<Request, Response> => {
 ...
 * @returns {RequestHandler<Request, Response>} Middleware configurado.
 *
 * @example
 ...
 * ```
 */
export const files = (...allowedMimes: string[]): RequestHandler<FilesRequest> => {
...
export const StacksController =
	(filePath: string): RequestHandler<Request, Response> =>
	(req, res, next) => {
